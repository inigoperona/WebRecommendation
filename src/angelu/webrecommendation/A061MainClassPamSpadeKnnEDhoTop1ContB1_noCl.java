...
/**
 * The Class A061MainClassPamSpadeKnnEDhoTop1ContB1_noCl.
 */
public class A061MainClassPamSpadeKnnEDhoTop1ContB1_noCl {
	...
	public static void main(String[] args) {
		...
		param.runModelEvaluatorMC("ContentsB1_noCl");
