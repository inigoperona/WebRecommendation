...
/**
 * The Class RecommenderKnnToClustersTopURLsAndContentsA2_SpOrder.
 */
public class RecommenderKnnToClustersTopURLsAndContentsA2_SpOrder 
				extends RecommenderKnnToClustersTopURLsAndContentsA2 {

	// CREATOR
	
	/**
	 * Instantiates a new recommender knn to clusters top ur ls and contents a2_ sp order.
	 *
	 ...
	 */
	public RecommenderKnnToClustersTopURLsAndContentsA2_SpOrder(
