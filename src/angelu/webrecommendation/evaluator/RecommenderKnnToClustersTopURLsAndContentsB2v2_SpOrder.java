...
/**
 * The Class RecommenderKnnToClustersTopURLsAndContentsB2v2_SpOrder.
 */
public class RecommenderKnnToClustersTopURLsAndContentsB2v2_SpOrder 
				extends RecommenderKnnToClustersTopURLsAndContentsB2v2{

	// CREATOR
	
	/**
	 * Instantiates a new recommender knn to clusters top ur ls and contents b2v2_ sp order.
	 *
	 ...
	 */
	public RecommenderKnnToClustersTopURLsAndContentsB2v2_SpOrder(
