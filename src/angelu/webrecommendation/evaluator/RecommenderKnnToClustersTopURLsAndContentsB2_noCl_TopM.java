...
/**
 * The Class RecommenderKnnToClustersTopURLsAndContentsB2_noCl_TopM.
 */
public class RecommenderKnnToClustersTopURLsAndContentsB2_noCl_TopM 
				extends RecommenderKnnToClustersTopURLsAndContents {

	// CREATOR
	
	/**
	 * Instantiates a new recommender knn to clusters top ur ls and contents b2_no cl_ top m.
	 *
	 ...
	 */
	public RecommenderKnnToClustersTopURLsAndContentsB2_noCl_TopM(
