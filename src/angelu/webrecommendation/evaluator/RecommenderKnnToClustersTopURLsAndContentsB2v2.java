...
/**
 * The Class RecommenderKnnToClustersTopURLsAndContentsB2v2.
 */
public class RecommenderKnnToClustersTopURLsAndContentsB2v2
				extends RecommenderKnnToClustersTopURLsAndContents {

	// CREATOR
	
	/**
	 * Instantiates a new recommender knn to clusters top ur ls and contents b2v2.
	 *
	 ...
	 */
	public RecommenderKnnToClustersTopURLsAndContentsB2v2(
