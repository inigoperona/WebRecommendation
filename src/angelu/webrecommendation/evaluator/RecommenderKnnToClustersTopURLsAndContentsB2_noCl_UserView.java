...
/**
 * The Class RecommenderKnnToClustersTopURLsAndContentsB2_noCl_UserView.
 */
public class RecommenderKnnToClustersTopURLsAndContentsB2_noCl_UserView 
				extends RecommenderKnnToClustersTopURLsAndContents {

	// CREATOR
	
	/**
	 * Instantiates a new recommender knn to clusters top ur ls and contents b2_no cl_ user view.
	 *
	 ...
	 */
	public RecommenderKnnToClustersTopURLsAndContentsB2_noCl_UserView(
