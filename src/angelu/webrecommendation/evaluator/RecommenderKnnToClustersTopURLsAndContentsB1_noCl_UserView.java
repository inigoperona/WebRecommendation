...
/**
 * The Class RecommenderKnnToClustersTopURLsAndContentsB1_noCl_UserView.
 */
public class RecommenderKnnToClustersTopURLsAndContentsB1_noCl_UserView 
				extends RecommenderKnnToClustersTopURLsAndContents {

	// CREATOR
	
	/**
	 * Instantiates a new recommender knn to clusters top ur ls and contents b1_no cl_ user view.
	 *
	 ...
	 */
	public RecommenderKnnToClustersTopURLsAndContentsB1_noCl_UserView(
