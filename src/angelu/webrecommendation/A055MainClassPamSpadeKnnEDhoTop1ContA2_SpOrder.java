...
/**
 * The Class A055MainClassPamSpadeKnnEDhoTop1ContA2_SpOrder.
 */
public class A055MainClassPamSpadeKnnEDhoTop1ContA2_SpOrder {
	...
	public static void main(String[] args) {
		...
		param.runModelEvaluatorMC("ContentsA2_SpOrder");
