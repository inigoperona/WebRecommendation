...
/**
 * The Class A061MainClassPamSpadeKnnEDhoTop1ContB2v2_noCl.
 */
public class A061MainClassPamSpadeKnnEDhoTop1ContB2v2_noCl {
	...
	public static void main(String[] args) {
		...
		param.runModelEvaluatorMC("ContentsB2v2_noCl");
