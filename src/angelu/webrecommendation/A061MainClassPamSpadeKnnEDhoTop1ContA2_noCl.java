...
/**
 * The Class A061MainClassPamSpadeKnnEDhoTop1ContA2_noCl.
 */
public class A061MainClassPamSpadeKnnEDhoTop1ContA2_noCl {
	...
	public static void main(String[] args) {
		...
		param.runModelEvaluatorMC("ContentsA2_noCl");
