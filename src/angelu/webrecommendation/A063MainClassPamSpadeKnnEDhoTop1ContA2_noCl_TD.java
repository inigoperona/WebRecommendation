...
/**
 * The Class A063MainClassPamSpadeKnnEDhoTop1ContA2_noCl_TD.
 */
public class A063MainClassPamSpadeKnnEDhoTop1ContA2_noCl_TD {
	...
	public static void main(String[] args) {
		...
		param.runModelEvaluatorMC("ContentsA2_noCl_TD");
