...
public class A059MainClassTop07_1 {
	...
	public static void main(String[] args) {
		...
		String clusterPartitionFile = "contentEnrichment/OntologySimilarity/clusterPartitions/ClusterPartitionModua0.txt";
		...
		for(int j=0; j<ks.length; j++){
			...
			for(int l=0; l<seqweights.length; l++){
				...
				for(int ind=0; ind<nrecsWSTv.length; ind++ ){
					...
					modelev.setEsploitationParameters("Top07_1", 
