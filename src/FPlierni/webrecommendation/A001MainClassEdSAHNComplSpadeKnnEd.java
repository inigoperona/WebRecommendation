 ...
 */
public class A001MainClassEdSAHNComplSpadeKnnEd {
	...
	public static void main(String[] args) {
		...
		*/
		...
		BufferedWriter evalWriter = A001MainClassEdSAHNComplSpadeKnnEd.openFile(var_validationWD + var_evalFile);
		// Results' header
		...
		A001MainClassEdSAHNComplSpadeKnnEd.closeFile(evalWriter);
	}
