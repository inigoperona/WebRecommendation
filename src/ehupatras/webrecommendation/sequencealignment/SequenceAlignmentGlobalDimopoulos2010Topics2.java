...
/**
 * The Class SequenceAlignmentGlobalDimopoulos2010Topics2.
 */
public class SequenceAlignmentGlobalDimopoulos2010Topics2 
				extends SequenceAlignmentGlobalDimopoulos2010 {

	/**
	 * Instantiates a new sequence alignment global dimopoulos2010 topics2.
	 *
	 * @param urlIDs the url i ds
	 * @param url2topic the url2topic
	 * @param topicmatch the topicmatch
	 */
	public SequenceAlignmentGlobalDimopoulos2010Topics2(ArrayList<Integer> urlIDs, int[] url2topic, float topicmatch){
		m_UrlIDs = urlIDs;
