...
length(unique(cutree(hc, h=0.91))) # 16 clusters
length(unique(cutree(hc, h=0.92))) # 15 clusters
length(unique(cutree(hc, h=0.93))) # 15 clusters
length(unique(cutree(hc, h=0.94))) # 15 clusters
length(unique(cutree(hc, h=0.95))) # 15 clusters ##
length(unique(cutree(hc, h=0.96))) # 15 clusters
length(unique(cutree(hc, h=0.97))) # 14 clusters
length(unique(cutree(hc, h=0.98))) # 13 clusters
length(unique(cutree(hc, h=0.99))) # 8 clusters
